Pod::Spec.new do |spec|
  ...
  spec.source           = { :git => "https://github.com/AloneMonkey/MonkeyDevPod.git", :tag => spec.version.to_s }  #代码的git地址以及tag
  spec.source_files     = "MonkeyPod/*.{h,m}"        #本地验证这里填  "./**/*"  表示当前目录以及子目录的所有文件   如果发布到MonkeyPodSpec需要填写git clone下来的对应的路径
  spec.public_header_files = "MonkeyPod.h"        #需要对外导出的头文件  此处为本地验证
